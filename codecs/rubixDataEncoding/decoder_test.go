...
func TestSerialDataFull(t *testing.T) {
	t.Skip("Buffer exercises MDK_UO/UI/DO/DI (17-20), whose metadata is deliberately absent: adding it desynchronises the real-device fixtures in pkg (TestEncryptedRubixPayload). Pending hardware investigation of where those frames lose alignment.")
